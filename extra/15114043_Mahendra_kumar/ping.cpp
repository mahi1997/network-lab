...
//here     sudo ./ping 8.8.8.8      for google
//sudo is compulsory elese you will get error sudo will give permissions to ping

//include  icmp.h  is necessary i.e. header for ICMP packets here in this code
...
//tv_sub(tvrecv, tvsend);        //what is this???

double rtt = (double)(tvrecv->tv_sec - tvsend->tv_sec) * 1000.0 + (double)(tvrecv->tv_usec - tvsend->tv_usec)  / 1000.0;  //datatype for rtt??
printf("%d bytes from %s: seq=%u, ttl=%d, rtt=%.3f ms\n",
icmplen, host,icmp->un.echo.sequence, ip->ttl, rtt);
